...
import com.projectBasic.JVBasicCourse.entities.Payment;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        p1.getCategories().add(cat2);//estou adicionando p1 a categoria 2
        ...
        Payment pay1 = new Payment(null, Instant.parse("2022-06-20T21:53:02Z"), o1);
        o1.setPayment(pay1);
